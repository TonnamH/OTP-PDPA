...
const Icon = ({ name, className = '', size = 20, color = 'currentColor', strokeWidth = 1.6 }) => {
  const icons = {
    settings: (
    ...
    folder_off: (
      <path d="M9 13h6m-3-3v6m-9 1V7a2 2 0 012-2h4l2 2h4a2 2 0 012 2v1m-5 14H5a2 2 0 01-2-2v-6a2 2 0 012-2h14a2 2 0 012 2v6a2 2 0 01-2 2h-4" />
    ),
    video: (
      <>
