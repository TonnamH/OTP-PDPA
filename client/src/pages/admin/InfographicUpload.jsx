...
export default function InfographicUpload() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await adminApi.post('/infographics/upload', formData);
            ...
            const errorMsg = error.response?.data?.error || t('adminUploadInfo.messages.errorGeneric') || 'Cannot connect to the server.';
