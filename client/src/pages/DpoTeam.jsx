...
import FadeIn from '../components/FadeIn'; // <-- Import the FadeIn component safely
...
export default function DpoTeam() {
  ...
  return (
    <div style={{ backgroundColor: 'var(--bg-white)', minHeight: '100vh', paddingBottom: '5rem' }}>
      ...
      {/* 2. Organizational Chart - Fading the whole section at once to protect your CSS layout */}
      <FadeIn delay={0.2}>
      ...
      <FadeIn delay={0.3}>
        <section className="section-full" style={{ paddingTop: '2rem', backgroundColor: 'var(--bg-paper)' }}>
          <div className="container" style={{ maxWidth: '900px' }}>
            ...
            {/* The raw list is kept intact so the 1. 2. 3. 4. numbering doesn't break! */}
